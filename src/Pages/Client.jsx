        ...
        <div className="container">
          <div className="row g-5 d-flex align-items-center justify-content-center text-md-start text-center">
            <div className="col-md-7 col-12 mb-md-0 mb-3">
                ...
                <p className="client_text">ValuGenius is a IBBI Registered Valuation firm situated in Mumbai, India. We are actively engaged in offering Valuation and advisory support to Indian and foreign companies.</p>
